...
function M.setup(channel, opts)
  ...
  -- Surface-mode navbar (docs/design/surface-navbar-v1.md). Set up after
  -- chrome (reads its sidebar state) and before minimap/git (subscribes to
  -- git.on_update so it gets the very first refresh's data).
