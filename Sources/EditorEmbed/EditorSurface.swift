...
public struct EditorSurface: NSViewRepresentable {
    ...
    /// that inject a controller they already started pass false.
    ...
    /// nvim session (and its child process) with the view.
    nonisolated public static func dismantleNSView(_ nsView: EditorHostNSView, coordinator: Void) {
